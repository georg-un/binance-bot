...
con = database_client.get_database_connection()
...
for pair in pairs:
    ...
    database_client.create_klines_table(db_con=con, pair=pair)
    database_client.insert_klines_into_table(db_con=con, pair=pair, data=data)
con.close()
